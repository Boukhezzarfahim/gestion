<div>
    <div class="row p-4 pt-5">
        ...
        <div class="card-tools d-flex align-items-center">
            <a class="btn btn-link text-white mr-4 d-block"><i class="fas fa-user-plus"></i> Nouvel utilisateur</a>
        ...
        <tbody>
            ...
            <td  class="text-center"><span class="tag tag-success"></span>{{$user->created_at}}</td>
